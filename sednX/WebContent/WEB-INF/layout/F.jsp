...
<!-- 가로형 리스트 -->
				<div class="slider_form">
					<h2>가로형 리스트 123<span><a href="#"><img src="img/img_add.png" alt="더보기"/></a></span></h2>
					...
					<div class="list-x">
						...
						<div class="contents_form">
							...
							<div class="wp50 float-right">
								<div class="text-list">
									<p class="f18 lh20 fw600">레디 플레이어 원<span class="filePoint"></span></p>
						...
						<div class="contents_form">
							...
							<div class="wp50 float-right">
								<div class="text-list">
									<p class="f18 lh20 fw600">지금만나러 갑니다<span class="filePoint"></span></p>
									<div class="f13 fw500 mt-10">
										2018.04.21
										<span class="down ml-10"><img src="img/btn_file.png" alt="다운로드" /></span>
										<span class="hits ml-10">50</span>
						...
						<div class="contents_form">
							...
							<div class="wp50 float-right">
								<div class="text-list">
									<p class="f18 lh20 fw600">바람바람바람<span class="filePoint"></span></p>
									<div class="f13 fw500 mt-10">
										2018.04.21
										<span class="down ml-10"><img src="img/btn_file.png" alt="다운로드" /></span>
										<span class="hits ml-10">50</span>
						...
						<div class="contents_form">
							...
							<div class="wp50 float-right">
								<div class="text-list">
									<p class="f18 lh20 fw600">덕구<span class="filePoint"></span></p>
									<div class="f13 fw500 mt-10">
										2018.04.21
										<span class="down ml-10"><img src="img/btn_file.png" alt="다운로드" /></span>
										<span class="hits ml-10">50</span>
						...
						<div class="contents_form">
							...
							<div class="wp50 float-right">
								<div class="text-list">
									<p class="f18 lh20 fw600">콜럼버스<span class="filePoint"></span></p>
									<div class="f13 fw500 mt-10">
										2018.04.21
										<span class="down ml-10"><img src="img/btn_file.png" alt="다운로드" /></span>
										<span class="hits ml-10">50</span>
						...
						<div class="contents_form">
							...
							<div class="wp50 float-right">
								<div class="text-list">
									<p class="f18 lh20 fw600">몬테나<span class="filePoint"></span></p>
									<div class="f13 fw500 mt-10">
										2018.04.21
										<span class="down ml-10"><img src="img/btn_file.png" alt="다운로드" /></span>
										<span class="hits ml-10">50</span>
