...
<div class="slider_form">
	<h2>기본 가로형 썸네일<span><a href="#"><img src="img/img_add.png" alt="더보기"/></a></span></h2>
	
	<div class="default-x">

		<div class="contents_form">
			<div class="text">레디 플레이어 원</div>
			<div class="text-over">
				<div class="header">
		...
		<div class="contents_form">
			...
			<div class="text-over">
				...
				<div class="body text-center f15">
					<p>세상을 떠난 그녀가 다시 돌아왔다.<br />모든 기억을 잃은 채.</p>
				</div>
				<div class="footer text-center">
					<hr />
					<p>지금만나러 갑니다</p>
		...
		<div class="contents_form">
			...
			<div class="text-over">
				...
				<div class="body text-center f15">
					<p>안녕 내 이름은 "레이디 버드"라고 해  다른 이름이 있지만, 내가 나에게 이름을 지어줬지<br/>모두가 나에게 잘 살아보라고 충고로 위장한 잔소리를 해<br/>하지만 지금 이 모습...</p>
				</div>
				<div class="footer text-center">
					<hr />
					<p>바람 바람 바람</p>
		...
		<div class="contents_form">
			<div class="text">어벤져스 : 인피니티 워</div>
			<div class="text-over">
				<div class="header">
					<span class="hits">50</span>
					<span class="down ml-10"><img src="img/btn_file.png" alt="다운로드" /></span>
			...
			<div class="gra"></div>
			<div class="img"><img src="img/img_contents_11.png" alt="컨텐츠이미지" /></div>
		</div>

		<div class="contents_form">
			<div class="text">콜럼버스</div>
			<div class="text-over">
				<div class="header">
					<span class="hits">50</span>
					<span class="down ml-10"><img src="img/btn_file.png" alt="다운로드" /></span>
